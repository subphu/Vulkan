...
private:
    ...
    void createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) {
        ...
        if (vkCreateImage(device, &imageInfo, nullptr, &image) != VK_SUCCESS) {
            throw std::runtime_error("failedd to create image!");
        }
    ...
    void createTextureImage() {
        ...
        stbi_uc* pixels = stbi_load("textures/rustediron/rustediron_albedo.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
    ...
    VkShaderModule createShaderModule(const std::vector<char> & code) {
        ...
        if (vkCreateShaderModule(device, &createInfo, nullptr, &shaderModule) != VK_SUCCESS) {
            throw std::runtime_error("failed to create shader moduel!");
        }
        return shaderModule;
    }
    ...
    int rateDeviceSuitability(VkPhysicalDevice device) {
        ...
        score += deviceFeatures.samplerAnisotropy ? 200 : 0;
